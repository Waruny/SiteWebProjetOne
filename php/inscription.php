    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" name="username" class="form-control" placeholder="Identifiant" value="<?php echo $username; ?>">
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="password" name="confirm_password" class="form-control" placeholder="Mot de passe" value="<?php echo $confirm_password; ?>">
                <span class="help-block"><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label>Adresse mail</label>
                <input type="mail" name="mail" class="form-control" placeholder="Mail" value="<?php echo $mail; ?>">
